...
public class PlanterServiceImpl implements PlanterService{
	...
	@Override
	public List<Planter> viewPlanterByPlanterShape(String PlanterShape) throws PlanterException {
		
       if(PlanterShape==null) throw new PlanterException("Planter Details are not valid !!");
		
		List<Planter> planter= planterrepository.findByPlanterShape(PlanterShape);
